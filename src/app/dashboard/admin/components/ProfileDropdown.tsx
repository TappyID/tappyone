  ...
  return (
    <motion.div className="relative">
      <motion.button
        ...
        className="flex items-center gap-2.5 h-10 px-3 rounded-lg backdrop-blur-sm border border-white/20 bg-white/10 hover:bg-white/20 text-white transition-all duration-300 shadow-sm hover:shadow-lg"
      >
        <div className="w-7 h-7 rounded-lg flex items-center justify-center bg-gradient-to-br from-white/30 to-white/10">
            ...
            <div className="p-6 border-b border-white/10">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center bg-gradient-to-br from-white/30 to-white/10">
            ...
            <div className="p-4 border-t border-white/10 bg-white/5">
              <div className="flex items-center justify-between">
                ...
                <motion.button
                  ...
                  className="px-4 py-2 border rounded-lg text-sm font-medium transition-all bg-gradient-to-r from-red-500/20 to-red-600/20 border-red-400/30 text-red-300 hover:from-red-500/30 hover:to-red-600/30"
                >
                  Sair
                </motion.button>
              </div>
